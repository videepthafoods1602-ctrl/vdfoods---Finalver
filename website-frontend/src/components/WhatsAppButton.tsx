    ...
    return (
        ...
        >
            ...
            <a
                ...
                className="w-12 h-12 sm:w-16 sm:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_10px_25px_rgba(37,211,102,0.4)] text-white hover:bg-[#20ba59] transition-all"
                aria-label="Contact on WhatsApp"
            >
                <svg className="w-6 h-6 sm:w-8 sm:h-8" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
